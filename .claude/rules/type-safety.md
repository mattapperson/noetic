...
7. **Zod schemas** - Use for all API interfaces and runtime validation (tool/`step.llm`/sub-harness schemas additionally accept any Standard Schema v1 validator; Zod remains the default and is required everywhere else — channels, layers, item schemas, workflows)
