import type { ExecutionContext, LayerDataDecl, LayerFunctionDecl } from '@noetic-tools/types';
import type { ZodType } from 'zod';

/**
 * Creates a read-only data declaration for a context layer's `provides` map.
 *
 * @public
...
/**
 * Creates a callable function declaration for a context layer's `provides` map.
 * Functions are accessible via `ctx.context['layerId'].fn()` and automatically exposed as LLM tools.
 *
 * @public
