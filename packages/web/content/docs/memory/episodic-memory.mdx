...
Orchid provides the slot constant and lifecycle hooks. You implement the layer with your preferred summarization and retrieval strategy:
...
- [Semantic Recall](/docs/memory/semantic-recall) -- vector-indexed retrieval for larger knowledge bases
- [Custom Layers](/docs/memory/custom-layers) -- full guide to implementing any memory layer
