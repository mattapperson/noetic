...
You can use the built-in `InMemoryAgentHarness` for development or implement a persistent adapter backed by a database or file system.
...
- [Working Memory](/docs/memory/working-memory) -- lightweight scratchpad alternative
- [Custom Layers](/docs/memory/custom-layers) -- build your own persistence layer
