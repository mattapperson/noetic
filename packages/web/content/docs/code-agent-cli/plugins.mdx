---
title: Plugins
description: Extend the noetic CLI with custom tools, context layers, skills, slash commands, footer UI, sub-agent presets, reminder triggers, and language servers.
---
...
interface NoeticPlugin {
  ...
  contextLayers?: (ctx: PluginContext) => ReadonlyArray<ContextLayer> | Promise<ReadonlyArray<ContextLayer>>;
...
Contribute custom [context layers](/docs/framework/context-layers/custom-layers). Layers participate in budget allocation and recall just like the built-ins.
