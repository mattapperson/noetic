...
This is the same shape as the production flow at `packages/cli/src/commands/builtins/tasks/hierarchy/validator-flow.ts`, just with the lifecycle persistence and per-task lookup omitted.
