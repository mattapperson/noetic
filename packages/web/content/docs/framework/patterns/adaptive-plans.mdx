...
```ts
import { adaptivePlan, react, step, PlanNodeSchema } from '@noetic-tools/core';
...
- [Task Trees](/docs/framework/patterns/task-trees) -- static plan compilation
- [Ralph Wiggum](/docs/framework/patterns/ralph-wiggum) -- self-refinement at the output level rather than the plan level
