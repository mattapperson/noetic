...
- [Overview](/docs/overview) -- architecture summary
- [Memory Layer System](/docs/memory) -- budget allocation details
- [Spawn](/docs/operators/spawn) -- context strategies in depth
