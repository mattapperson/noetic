...
```ts
import { historyWindow, observationalContext, workingMemoryContext } from '@noetic-tools/core';
...
- `/config` slash command → **Context** tab → **History Window (items)**. Leave blank to disable.
