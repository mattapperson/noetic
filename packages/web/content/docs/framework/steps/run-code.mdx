...
- [callModel](/docs/framework/steps/call-model) -- for language model calls.
- [invokeTool](/docs/framework/steps/invoke-tool) -- for direct tool invocation.
- [Loop & Until](/docs/framework/operators/loop-and-until) -- use `runCode` as a loop body for custom iteration logic.
