...
- [Custom Layers](/docs/framework/memory/custom-layers) -- full guide to building any memory layer
- [Memory Layer System](/docs/framework/memory) -- how slots, scopes, and budgets work together
