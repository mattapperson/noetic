...
const router = conditional({
  ...
  route: semanticSwitch({
    ...
    cases: {
      ...
      'complaint or feedback': callModel({ id: 'feedback', model: 'openai/gpt-4o' }),
    },
    threshold: 0.7,
  }),
});
    ...
    cases: [
      {
        ...
        step: callModel({ id: 'greet', model: 'openai/gpt-4o-mini' }),
      },
      {
        labels: 'technical question',
        step: callModel({ id: 'tech', model: 'openai/gpt-4o' }),
      },
    ],
    default: callModel({ id: 'fallback', model: 'openai/gpt-4o-mini' }),
    threshold: 0.7,
  }),
});
```
