...
See [Semantic Conditions](/docs/operators/conditions) for the full API, including condition combinators, caching, and custom conditions.

## Related

- [fork](/docs/operators/fork) -- parallel execution for when you need multiple paths at once.
- [Steps](/docs/steps) -- the step types you can return from a route function.
- [Loop & Until](/docs/operators/loop-and-until) -- combine branching with iteration.
