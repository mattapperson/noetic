---
title: Until Types
description: Type definitions for termination predicates, verdicts, snapshots, and combinators in Orchid.
---
...
| Field | Type | Description |
|---|---|---|
| `threshold` | `number` | Reserved for future similarity-based convergence. Currently uses exact string equality. |
...
```ts
import { until, any, all } from '@orchid/core';
