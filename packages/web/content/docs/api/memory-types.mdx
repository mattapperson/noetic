---
title: Memory Types
description: Type definitions for memory layers, hooks, storage adapters, and projection policies in Orchid.
---
...
| `spawnOpts` | `SpawnOptions` | Spawn configuration |
...
| Field | Type | Description |
|---|---|---|
| `contextIn` | `string` | Context input strategy name |
| `contextOut` | `string` | Context output strategy name |
