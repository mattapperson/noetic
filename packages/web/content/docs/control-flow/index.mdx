...
See [Semantic Conditions](/docs/control-flow/conditions) for the full API: `semanticSwitch`, `semanticRoute`, `embeddingMatch`, `aiCondition`, combinators, and caching.
...
- [Semantic Conditions](/docs/control-flow/conditions) -- AI-powered routing with embeddings and LLM classifiers.
