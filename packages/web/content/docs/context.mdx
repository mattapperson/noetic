...
Persists the current execution state so it can be restored later. In the `InMemoryAgentHarness` this is a no-op; durable agent harnesses use it for crash recovery.
