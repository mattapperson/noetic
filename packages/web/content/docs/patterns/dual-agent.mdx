...
```ts
import { channel, spawn, react, fork, step } from '@orchid/core';
import { z } from 'zod';
...
- [Channels](/docs/channels) -- channel types and usage
- [Spawn](/docs/spawn) -- isolated child execution
- [A2A Remote](/docs/patterns/a2a-remote) -- cross-process variant
