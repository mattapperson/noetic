/**
 * Skills context layer — progressive disclosure of skill instructions.
 *
...
import { findFunctionCall } from '@noetic-tools/context';
...
export function skillsLayer(skills: SkillDefinition[]): ContextLayer<SkillsLayerState> {
  return {
    id: 'skills-context',
