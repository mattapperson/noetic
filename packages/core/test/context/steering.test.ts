...
/** Create a steering layer cast to ContextLayer for use in lifecycle functions. */
function createSteeringLayer(config: SteeringConfig): ContextLayer {
  return frameworkCast<ContextLayer>(steering(config));
}
