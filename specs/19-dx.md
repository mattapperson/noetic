...
- Introduce no more than three Noetic concepts (e.g., `step.llm`, `run`, `InMemoryAgentHarness`)
...
4. How to write unit tests for a custom agent harness using `InMemoryAgentHarness` as a reference
