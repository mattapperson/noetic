...
Builder functions for the base step variants are flat top-level exports; only the coding-agent builder stays grouped under the `step` namespace:
...
step.acpAgent(...)     // the coding-agent builder keeps the `step.` prefix
```
