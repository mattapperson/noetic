...
- `bun test` — runs `@noetic-tools/types`, `@noetic-tools/context`, `@noetic-tools/core`, `@noetic-tools/code-agent`, `@noetic-tools/eval` suites **sequentially** (does NOT include `@noetic-tools/cli`)
